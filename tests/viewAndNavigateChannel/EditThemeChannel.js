...
describe('Test 23', function () {
    ...
    tags('e2e').it('Test', async () => {
        ...
        await SettingChannelForm.clickthemeEditChannel();
        await SettingChannelForm.setinputEditNameChannel('edit');
        await SettingChannelForm.clickbuttonSaveEditThemeChannel();
        await SettingChannelForm.isVisible();
